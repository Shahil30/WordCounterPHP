...
<body>
 ...
 <div id="container">
    <h1>Word Counter</h1>
    <form id="wordCounterForm" action="" method="post">
        <textarea name="sentence" id="inputField" placeholder="Enter text..." rows="4"></textarea><br>
        <?php
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            $sentence = $_POST["sentence"];
            $wordCount = str_word_count($sentence);
            echo '<textarea id="outputField" name="wordCountResult" readonly>' . $wordCount . ' words</textarea>';
        } else {
            echo '<textarea id="outputField" name="wordCountResult" readonly></textarea>';
        }
        ?>
        <br>
